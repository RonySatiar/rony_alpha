...
function alpha_bootstrapping()
{
    ...
    add_theme_support("post-formats", array("image", "quote", "video", "audio", "link", "url"));
}
...
add_action("wp_head", "about_page_template_banner", 11);
